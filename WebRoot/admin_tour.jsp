...
$(function(){
	...
	$(function(){
		$("#dataLoad").datagrid({
			...
			checkOnSelect : true,
			columns:[[    
			          {field:'tid',title:'编号',width:200},    
			          {field:'tname',title:'用户名',width:100},    
			          {field:'prime_price',title:'原价',width:100},    
			          {field:'group_buying',title:'团购价',width:100},    
			          {field:'vaca_days',title:'出行时间',width:100},    
			          {field:'vaca_per',title:'出行人数',width:100},    
			          {field:'img_url',title:'图片地址',width:100}, 
			          {field:'pecommend',title:'特别优惠',width:100}, 
			          {field:'favorable',title:'简介',width:100,align:'right'}    
			      ]],
